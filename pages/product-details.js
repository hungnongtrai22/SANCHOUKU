...
const ProductDetails = () => {
  ...
  return (
    <Layout>
      <PageBanner pageName={t('productDetails')} />
            ...
            <div className="col-xl-5 col-lg-6">
              <div className="product-details-content mb-30 wow fadeInRight delay-0-2s">
                <div className="off-ratting mb-15">
                  <span className="off">20% {t('off1')}</span>
                ...
                <span className="price mb-20">100.000đ</span>
                <hr />
                <form
                ...
                >
                  ...
                  <button type="submit" className="theme-btn">
                    {t('add')} <i className="fas fa-angle-double-right" />
                  </button>
                </form>
                <hr />
