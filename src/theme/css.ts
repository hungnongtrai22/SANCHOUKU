...
export const paper = ({
  ...
  ...(dropdown && {
    ...
    borderRadius: (theme as any).shape.borderRadius * 1.25,
  }),
});
...
export const menuItem = (theme: Theme) => ({
  ...
  borderRadius: (theme as any).shape.borderRadius * 0.75,
  '&:not(:last-of-type)': {
    marginBottom: 4,
  },
  [`&.${menuItemClasses.selected}`]: {
    fontWeight: (theme as any).typography.fontWeightSemiBold,
